...
Módulo para Inserção da Funcionalidade "Lista de Filmes Favoritos" (Acoplamento com projeto principal em estudo/pesquisa), já é possivel verificar funcionalidade de adicionar a lista (Botão ADD) e remover via evento de Click sobre o Item.
